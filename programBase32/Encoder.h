...
///@brief Хранит результат кодирования, а также предназначен для конструктора строкой.
     ...
     * полученное число после "отщипления" производит побитовую операцию "&" c числом 31, так как в алфавите Base32 - 32 основных символа.
     * Но побитовая операция "&" производится с числом 31, так как индексация в языке Cи++ начинается с 0.</p><br>
     *  @code
